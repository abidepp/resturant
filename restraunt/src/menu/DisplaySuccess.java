...
import com.example.restraunt.R.id;
import com.example.restraunt.R.layout;
import com.example.restraunt.R.menu;
...
public class DisplaySuccess extends ActionBarActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.display_success, menu);
		return true;
	}
